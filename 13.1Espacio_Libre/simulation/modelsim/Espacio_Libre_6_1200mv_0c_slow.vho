...
-- persona_ingresa	=>  Location: PIN_G18,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- clk	=>  Location: PIN_B2,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF Espacio_Libre IS
...
SIGNAL ww_persona_ingresa : std_logic;
SIGNAL ww_alarma : std_logic;
SIGNAL \persona_ingresa~input_o\ : std_logic;
...
ww_clk <= clk;
ww_persona_ingresa <= persona_ingresa;
alarma <= ww_alarma;
ww_devoe <= devoe;
ww_devclrn <= devclrn;
ww_devpor <= devpor;
...
\persona_ingresa~input\ : cycloneiii_io_ibuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	simulate_z_as => "z")
-- pragma translate_on
PORT MAP (
	i => ww_persona_ingresa,
	o => \persona_ingresa~input_o\);
